...
**DOC-A1 — Ghost Pensioners: Pension Fraud and Demographic Coercion in Mariupol** *(Briefing & Paper)* *(also: Coercion, Entrapment and Slavery)*
...
**DOC-B5 — Mariupol Property Seizure Programme: Interactive Dashboard** *(Dashboard)* *(also: Coercion, Entrapment and Slavery)*
...
**DOC-B6 — Mariupol Property Seizure Programme: Evidence from Occupation Administrative Records** *(Briefing & Paper)* *(also: Coercion, Entrapment and Slavery)*
...
**DOC-C5 — IDP Attitudes Survey: Raw Dataset (n=1,001)** *(Data)* *(also: Coercion, Entrapment and Slavery)*
...
**DOC-C7 — IDP Attitudes Survey: Interactive Dashboard (v2)** *(Dashboard)* *(also: Coercion, Entrapment and Slavery)*
...
**DOC-D3 — Russia Is Ethnically Cleansing Mariupol** *(Briefing & Paper)* *(also: Coercion, Entrapment and Slavery)*
...
### Coercion, Entrapment and Slavery
...
**DB-ZAP — Zaporizhzhia Occupation Press: Issue Index & Theme Data (145 issues, 2024–2026)** *(Information Space)*
A derived dataset from 145 issues of the two newspapers of АНО «ЗаМедиа», the occupation media holding for Russian-occupied Zaporizhzhia oblast: the weekly regional flagship «Запорожский вестник» (119 issues, Mar 2024 to Jul 2026) and the official gazette «Запорожская правда» (26 issues, Feb 2024 to Feb 2025), the latter issued as separate per-municipality editions across thirteen municipalities. Records issue date, issue and cumulative number, page count, municipality edition and source, plus keyword counts for ten occupation themes. The data shows a sharp division of labour: the gazette carries the legal-administrative load (60.11 legal-register keyword hits per page against the flagship's 1.46), while the flagship carries loyalty and enemy-framing content. The gazette's print archive ends on 5 February 2025, when official publication of municipal acts moved to a registered network edition run by the same holding. Metadata and counts only; the PDFs and full text are held privately, and ZaMedia asserts copyright over its content.
...
**DOC-132 — Russian National Guard (Rosgvardia) Security Services at a Kindergarten, Telmanovsky District (redacted)** *(Coercion, Entrapment and Slavery, Education and Militarisation)*
...
**DOC-121 — Russian Federation Federal Law No. 423-FZ — Mandatory Military Training in Schools (4 August 2023)** *(Governance, Education and Militarisation, Coercion, Entrapment and Slavery)*
...
**DOC-165: Rosmolodezh Methodological Recommendations on Preventing the Spread of the Ideology of Terrorism, Extremism and Neo-Nazism among Young People from the Occupied Territories (28 February 2025)** *(Coercion, Entrapment and Slavery · Education and Militarisation · Identity, Culture and Religion)*
